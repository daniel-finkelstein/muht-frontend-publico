...
export default function DoctorCalendarPage() {
  ...
  const [dates, setDates] = useState([
    { id: 1, title: "Control Nutricional", date: "03-05-2026", time: "10:30", duration: "30 min", location: "Clínica Alemana Vitaucura", patient: "Roberto Roberts", doctor: "Dr. Gregorio Casa", status: "Pendiente", reminder: "Ayuno de 12 horas previas" },
    { id: 2, title: "Control Cardiológico", date: "07-05-2026", time: "14:00", duration: "45 min", location: "Clínica Las Condes", patient: "Roberto Roberts", doctor: "Dr. Juan Pérez", status: "Pendiente", reminder: "Comer al menos 5 horas antes" },
    { id: 3, title: "Control Endocrinológico", date: "24-05-2026", time: "9:00", duration: "30 min", location: "Clínica Santa María", patient: "Roberto Roberts", doctor: "Dra. Ana López", status: "Pendiente", reminder: "" },
    { id: 4, title: "Control General", date: "30-05-2026", time: "11:00", duration: "1 hr", location: "Clínica Dávila", patient: "Roberto Roberts", doctor: "Dr. Carlos Martínez", status: "Cancelada", reminder: "" },
    { id: 5, title: "Control Dermatológico", date: "05-06-2026", time: "15:30", duration: "30 min", location: "Clínica RedSalud", patient: "Roberto Roberts", doctor: "Dra. Laura Fernández", status: "Completada", reminder: "No usar cremas por de piel por 12 horas previo al control" },
  ]);
